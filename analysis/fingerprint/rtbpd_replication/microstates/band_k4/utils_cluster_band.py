# utils_cluster_band.py — SSH/SCP helpers for the band_k4 reanalysis.
# Identical logic to ../utils_cluster.py, just pointed at
# config_band_k4.CLUSTER_BASE instead of the parent config so this
# pipeline stays fully decoupled from the k=7 one.

import subprocess
from pathlib import Path

from config_band_k4 import CLUSTER_SSH, CLUSTER_BASE
