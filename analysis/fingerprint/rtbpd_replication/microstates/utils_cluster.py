# utils_cluster.py — rtBPD microstate pipeline
# SSH/SCP helpers, adapted from microstate_pda/utils.py's run_ssh / scp_to /
# make_cluster_dirs. Logic kept identical; only the DMNELF-specific config
# import and cluster subdirectory layout have been swapped out so this file
# has no DMNELF coupling.

import subprocess
from pathlib import Path

from config_rtbpd_ms import CLUSTER_SSH, CLUSTER_BASE
