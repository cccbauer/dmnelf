...
# ── Paths ──────────────────────────────────────────────────────────────────
EEG_RAW_ROOT = Path("/projects/swglab/data/rtBPD/rawdata_eeg")
EEG_OUT_ROOT = Path("/projects/swglab/data/rtBPD/derivatives/eeg_preprocessed")

SUBJECTS_EEG = [
    "sub-rtbpd002", "sub-rtbpd003", "sub-rtbpd004",
]
...
def _save_qc_raw(raw, eeg_ch_names, auto_bads,
    ...
    plt.tight_layout()
    fname = qc_dir / (subject + "_ses-nf_task-" + task
