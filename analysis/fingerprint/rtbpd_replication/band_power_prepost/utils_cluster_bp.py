# utils_cluster_bp.py — SSH/SCP helpers for the band-power pre/post pipeline.
# Identical logic to the microstate pipelines' utils_cluster.py, pointed
# at config_band_power.CLUSTER_BASE so this stays fully decoupled.

import subprocess
from pathlib import Path

from config_band_power import CLUSTER_SSH, CLUSTER_BASE
