...
by the sign-flip test (p ≤ 0.002).

**Table 1. Within-subject group-mean r (TR), by predictor (n = 17).**

| Target | EFP | HRF | T/A |
|---|---|---|---|
| CEN | **0.279** | 0.245 | 0.150 |
| PDA | **0.258** | 0.110 | 0.196 |
| GSR_CEN | **0.255** | 0.188 | 0.199 |
| DMN | 0.225 | 0.146 | *0.248* |
| GSR_PDA | **0.225** | 0.108 | 0.172 |
| VIS | **0.179** | 0.085 | 0.152 |
| GSR_DMN | **0.113** | 0.059 | 0.053 |
...
LOSO transfer was significant for the non-GSR targets (TR): PDA r = 0.127 (p = 0.010),
CEN r = 0.084 (p = 0.001), DMN r = 0.066 (p = 0.002), and the VIS control r = 0.084
(p = 0.004). GSR variants did not transfer (all p > 0.15), indicating that the
cross-subject component depends partly on the global signal.
