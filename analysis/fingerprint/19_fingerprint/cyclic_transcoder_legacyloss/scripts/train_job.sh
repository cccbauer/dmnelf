...
#SBATCH --array=0-29
#SBATCH --output=/projects/swglab/data/DMNELF/analysis/fingerprint/19_fingerprint/cyclic_transcoder_legacyloss/logs/train_%A_%a.out
#SBATCH --error=/projects/swglab/data/DMNELF/analysis/fingerprint/19_fingerprint/cyclic_transcoder_legacyloss/logs/train_%A_%a.err
