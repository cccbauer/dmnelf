...
#SBATCH --array=0-18
#SBATCH --output=/projects/swglab/data/DMNELF/analysis/fingerprint/19_fingerprint/cyclic_transcoder/logs/predict_%A_%a.out
#SBATCH --error=/projects/swglab/data/DMNELF/analysis/fingerprint/19_fingerprint/cyclic_transcoder/logs/predict_%A_%a.err

BASE=/projects/swglab/data/DMNELF/analysis/fingerprint/19_fingerprint/cyclic_transcoder
